...
const DashboardScreen = () => {
  ...
  const clickCollection = () => {
    navigateScreen(navigation, S_CollectionListScreen, {
    ...
    <MainContainer2>
      ...
      <View style={{flex: 1, paddingHorizontal: 30}}>
        ...
        <ButtonComponent
          ...
          height={50}
          tintColor={
            selectedWorkSpace?.id && selectedCollection?.id
          ...
          iconWidth={20}
          isDisabled={
            selectedWorkSpace?.id && selectedCollection?.id ? false : true
          }
