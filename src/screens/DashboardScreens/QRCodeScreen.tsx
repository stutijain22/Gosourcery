...
import { getEssentials, goBack, navigateScreen, parseData } from '../../utils/utility';
import { Camera, CameraType } from 'react-native-camera-kit';
import { deviceHeight, deviceWidth } from '../../styling/mixin';
import { StatusBar, View } from 'react-native';
import HeaderComponent from '../../common/HeaderComponent';
import { BACK_ARROW_ICON, QR_CODE_IMAGE  } from '../../utils/sharedImages';
import { DMSansBold, DMSansSemiBold, key_setUserScanData } from '../../constant/Constant';
        ...
        <MainContainer1>
         ...
         <View style={{flex:1, justifyContent: 'center', alignItems: 'center'}}>
          <View style={styles.qrCodeContainer}>
            ...
            <Spacer height={30} />
            <TextComponent value={'Scan QR Code'} 
            fontSize={40} 
