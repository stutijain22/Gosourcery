...
import {emailValidation, getEssentials, goBack} from '../../utils/utility';
...
import {K_EMAIL, KT_NEXT} from '../../constant/keyboardReturnType';
import {heightPercentageToDP} from '../../utils/responsiveUI';
import {DMSansMedium, DMSansSemiBold} from '../../constant/Constant';
  ...
  const sendClick = async () => {
    if (validateInputs()) {
      ...
      try {
        ...
        setModalVisible({
          title: 'Success',
          key: 'Reset code sent to your Email Address',
          value: true,
        });
        goBack(navigation);
      } catch (error: any) {
